...
public class ItemBonkHammer extends Item{

    private final Item.ToolMaterial material;
    protected float attackDamage;
    protected float attackSpeed;

    public ItemBonkHammer(Item.ToolMaterial material, float attackDamageIn, float attackSpeedIn)
    {
    ...
    /**
     * Gets a map of item attribute modifiers, used by ItemBonkHammer to increase hit damage.
     */
