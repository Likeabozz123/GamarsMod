...
public class ItemTestSeed extends Item implements IPlantable {

    public ItemTestSeed(String name) {
    ...
    public EnumActionResult onItemUse(EntityPlayer player, World worldIn, BlockPos pos, EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ) {
        ...
        if (facing == EnumFacing.UP && player.canPlayerEdit(pos.offset(facing), facing, stack)
            ...
            worldIn.setBlockState(pos.up(), BlockInit.TEST_PLANT.getDefaultState());
            stack.shrink(1);
    ...
    public IBlockState getPlant(IBlockAccess world, BlockPos pos) {
        return BlockInit.TEST_PLANT.getDefaultState();
    }
