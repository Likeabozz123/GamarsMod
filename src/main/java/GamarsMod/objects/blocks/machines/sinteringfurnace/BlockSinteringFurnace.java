package GamarsMod.objects.blocks.machines.sinteringfurnace;
...
public class BlockSinteringFurnace extends BlockBase {
    ...
    public BlockSinteringFurnace(String name) {
        super(name, Material.IRON, 8.0F, 8.0F, 3, "pickaxe");
    ...
    {
        if (!worldIn.isRemote) {
            playerIn.openGui(Main.instance, GuiRegistry.GUI_SINTERING_FURNACE, worldIn, pos.getX(), pos.getY(), pos.getZ());
        }
