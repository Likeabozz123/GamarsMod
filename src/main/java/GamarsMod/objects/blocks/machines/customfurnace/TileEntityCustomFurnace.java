...
public class TileEntityCustomFurnace extends TileEntity {
    ...
    {
        return this.hasCustomName() ? new TextComponentString(this.customName) : new TextComponentTranslation("container.custom_furnace");
    }
    ...
    public void update()
    {
        ...
        {
            --this.burnTime;
            BlockCustomFurnace.setState(true, world, pos);
        }
        ...
        else
        {
            ...
            {
                ItemStack output = CustomFurnaceRecipes.getInstance().getCustomResult(inputs[0], inputs[1]);
                if(!output.isEmpty())
                {
                    smelting = output;
                    cookTime++;
    ...
    private boolean canSmelt()
    {
        ...
        {
            ItemStack result = CustomFurnaceRecipes.getInstance().getCustomResult((ItemStack)this.handler.getStackInSlot(0), (ItemStack)this.handler.getStackInSlot(1));
