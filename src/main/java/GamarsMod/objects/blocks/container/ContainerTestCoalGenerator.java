package GamarsMod.objects.blocks.container;
...
public class ContainerTestCoalGenerator extends Container {

    private final TileEntityTestCoalGen tileentity;
    private int energy, cookTime;

    public ContainerTestCoalGenerator(InventoryPlayer player, TileEntityTestCoalGen tileentity)
    {
