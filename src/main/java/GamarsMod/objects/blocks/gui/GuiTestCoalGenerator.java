package GamarsMod.objects.blocks.gui;
...
public class GuiTestCoalGenerator extends GuiContainer {

    private static final ResourceLocation TEXTURES = new ResourceLocation(Reference.MOD_ID + ":textures/gui/test_coal_generator.png");
    private final InventoryPlayer player;
    private final TileEntityTestCoalGen tileentity;

    public GuiTestCoalGenerator(InventoryPlayer player, TileEntityTestCoalGen tileentity)
    {
        super(new ContainerTestCoalGenerator(player, tileentity));
        this.player = player;
    ...
    private int getEnergyStoredScaled(int pixels)
    {
        ...
        int j = this.tileentity.getMaxEnergyStore();
